# -*- coding: utf-8 -*-
"""Robust SVM solver implementation from the CVXOPT documentation

Taken verbatim from http://cvxopt.org/examples/mlbook/robsvm.html

Copyright 2004-2018, Martin S. Andersen, Joachim Dahl, and Lieven
Vandenberghe.
"""
